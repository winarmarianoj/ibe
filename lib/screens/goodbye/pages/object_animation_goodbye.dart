// screens/goodbye/pages/object_animation_goodbye.dart
...
class ObjectAnimationGoodbye extends StatefulWidget {
  const ObjectAnimationGoodbye({super.key});
  
  @override
  State<ObjectAnimationGoodbye> createState() => _ObjectAnimationGoodbyeState();
}

class _ObjectAnimationGoodbyeState extends State<ObjectAnimationGoodbye> with SingleTickerProviderStateMixin {   
  
  late AnimationController controller;
  // animaciones     
  late Animation<double> enlargeAnimation;
  late Animation<double> shrinkAnimation;
  late Animation<double> rotateAnimation = double.infinity as Animation<double>;
            ...
            child: Transform.rotate(
              ...
              child: Transform.scale(
                ...
                child: Transform.translate(
                  ...
                  child: Container(width: 220.0, height: 60.0, color: themeWelcomeTextBackground, 
                    child: RichText(
                        text: TextSpan(
                          children: [                              
                            TextSpan(
                              text: textGoodByeTitleAnimation,
                              style: Theme.of(context).textTheme.headlineLarge?.copyWith(
                                  color: themeGoodByeText, fontWeight: FontWeight.bold),
                            ),
                          ],
                        ),
                      ),    
