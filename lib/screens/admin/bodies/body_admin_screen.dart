...
class BodyAdminScreen extends StatefulWidget{
  ...
  const BodyAdminScreen({super.key, required this.personUser});  

  @override
  State<BodyAdminScreen> createState() => _BodyAdminScreenState(personUser: personUser);
}

class _BodyAdminScreenState extends State<BodyAdminScreen> {
  final PersonUser personUser;

  _BodyAdminScreenState({required this.personUser});

  @override
  Widget build(BuildContext context) {
    widget.personUser.setIsAdminHome = true;
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: MyBodyLargeText(
                          text: "Reporte de asistencias por fecha",
                          color: accentColor,
                      ...
                      const SizedBox(height: 5),
                      //DateRangePickerWidget(assistanceFormProvider: assistanceFormProvider,),
                      ...
                      MaterialButton(
                        ...
                        onPressed: assistanceFormProvider.isLoading && assistanceFormProvider.dateFrom.isNotEmpty && assistanceFormProvider.dateTo.isNotEmpty
                            ...
                            : () {
                                ...
                                reportAssistanceService.reportAssitance(assistanceFormProvider, context, personUser);
                              },
                        child: Container(
